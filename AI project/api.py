...
scaler = joblib.load('models/scaler.joblib') # هذا هو الـ scaler الذي يسبب المشكلة
...
categorical_features_mapping = {
    ...
    'ca': {0: 0.0, 1: 1.0, 2: 2.0, 3: 3.0, 4: 4.0}, # ca كانت float64 في notebook.ipynb وتم التعامل معها كفئة
    'thal': {0: 'fixed defect', 1: 'normal', 2: 'reversable defect', 3: 'reversable defect'} # افتراض أن 3 تعني نفس 2
}
